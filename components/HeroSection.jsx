...
export function HeroSection() {
  return (
    <div className="items-center sm:h-auto p-5  sm:grid grid-cols-2 sm:m-10" >
      ...
      <div className=" m-10 sm:ml-10 md:mr-4 text-left xl:mr-20">
        ...
        <div className="relative  w-full">
          ...
          <input
            type="text"
            className="h-10 xl:h-14  pl-10 w-72 md:w-64 lg:w-80 xl:w-96 rounded-lg z-0 focus:shadow focus:outline-none border border-gray-300"
            placeholder="Email Address"
          />
          <div className="absolute top-1 right-5 sm:right-0 md:right-2 lg:right-16 xl:right-40">
